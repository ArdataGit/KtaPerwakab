...
<div class="hidden md:flex md:w-72 md:flex-col border-r border-gray-200 bg-white">
    ...
    <div class="flex-1 flex flex-col overflow-y-auto mt-4 px-4 space-y-1 scrollbar-hide">
        ...
        @php($role = session('user.role') ?? 'publik')
        @if($role !== 'publik')
        ...
        <x-desktop.nav-link route="mobile.donation.jejak-hidup" active="jejak-hidup" icon="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
            Jejak Hidup
        </x-desktop.nav-link>
