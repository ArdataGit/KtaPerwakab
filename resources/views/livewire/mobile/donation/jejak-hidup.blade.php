...
mount(function () {
    $response = DonationApiService::jejakHidup([
...
<x-layouts.mobile title="Jejak Hidup">
    ...
    <div class="w-full bg-green-600 px-4 py-4 flex items-center space-x-3 rounded-b-2xl">
        ...
        <p class="text-white font-semibold text-base">Jejak Hidup</p>
    </div>
    ...
    <div class="px-4 mt-4 space-y-4">
        ...
        <div class="space-y-3">
            @forelse ($campaigns as $item)
                ...
                <div wire:key="jejak-{{ $item['id'] }}" class="bg-white rounded-xl p-2 shadow-sm flex space-x-3">
                    {{-- THUMBNAIL --}}
    ...
    {{-- ==================== DESKTOP VIEW ==================== --}}
    <x-slot:desktop>
        <x-desktop.layout title="Jejak Hidup">
            <div class="max-w-7xl mx-auto">
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-gray-900">Jejak Hidup</h1>
                    <p class="text-gray-500 mt-1">Daftar campaign dalam jejak hidup Anda.</p>
                </div>
                ...
                <div class="relative max-w-xl mb-8">
                    ...
                    <input type="text" wire:model.live="keyword" placeholder="Cari campaign..."
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @forelse ($campaigns as $item)
                        ...
                        <div wire:key="desktop-jejak-{{ $item['id'] }}"
                    ...
                    @empty
                        <div class="col-span-full flex flex-col items-center justify-center py-16 text-gray-400">
                            ...
                            <p class="text-sm font-medium">Belum ada data jejak hidup</p>
                        </div>
                    @endforelse
                </div>
            </div>
